...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Subcategorieën
            <small>Nieuwe subcategorie toevoegen</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="far fa-folder-plus"></i> Subcategorieën</a></li>
            ...
            <form role="form" method="post" action="{{ route('dashboard.categorieen.store') }}">
                ...
                <div class="box-body">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon">{{ route('welcome') }}/images/categories/</span>
                        <input type="text" class="form-control" placeholder="Categoriefoto" value="vegetables.jpg" id="image" name="image" required readonly>
                    </div>
                </div>
